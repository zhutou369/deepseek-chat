...
![Ollama CLI interface for running LLMs locally on Apple Silicon Mac](/static/posts/chat-generic-step.svg)
...
![LM Studio local inference server for DeepSeek on Mac](/static/posts/chat-generic-step.svg)
